...
(function(root, factory) {
    ...
    function isOfType(typeName) {
        return function(target) {
            var targetType = target[TYPE_KEY] || target.costructor && target.costructor[TYPE_KEY] || null;
            return targetType.length >= typeName.length && targetType.indexOf(typeName) === targetType.length - typeName.length;
        };
    }
